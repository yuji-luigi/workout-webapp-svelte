...
<dialog class="dialog" bind:this={dialog}>
  <div class="dialog-container">
    <div class="dialog-content">
      <div>
        {@html dialogStoreParams.component}
      </div>
    </div>
    <div class="dialog-actions">
      <button type="button" on:keydown={handleKeyDown} on:click={closeDialog}
        >Close</button
      >
      <button type="button" on:keydown={handleKeyDown} on:click={handleConfirm}
        >Confirm</button
      >
    </div>
  </div>
